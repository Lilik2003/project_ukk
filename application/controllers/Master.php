...
class Master extends CI_Controller
{
	...
	public function edit_admin($id)
	{
		...
		$data['admin'] = $this->M_master->edit_admin($where, 'tbl_admin')->result();
		$data['pengguna'] = $this->db->get_where('tbl_admin', ['username' => $this->session->userdata('username')])->row_array();
		$data['notif'] = $this->db->get('tbl_pengaduan')->result();

		$this->load->view('templates/header');
		$this->load->view('templates/sidebar');
		$this->load->view('master/admin/edit', $data);
		// $this->load->view('templates/footer');
	}
	public function update_admin($id)
	{
		...
		$this->M_master->update_admin($where, $data, 'tbl_admin');
...
// halaman edit petugas 
	...
	{
		$where = array('id_admin' => $id);
		$data['admin'] = $this->M_master->edit_petugas($where, 'tbl_admin')->result();
		$data['petugas'] = $this->db->get_where('tbl_admin', ['username' => $this->session->userdata('username')])->row_array();
		$data['notif'] = $this->db->get('tbl_pengaduan')->result();
	...
	public function update_petugas($id)
	{
		...
		$this->M_master->update_petugas($where, $data, 'tbl_admin');
		$this->session->set_flashdata('true', 'data berhasil di update');
