          ...
          <div class="row mb-3">
            <div class="col-lg-6">
              <div class="card shadow">
                <img src="<?= base_url('asset/upload/') . $pengaduan->foto; ?>" width="600" height="500">
            ...
            <div class="col-lg-6">
              <div class="card shadow">
                ...
                <div style="margin-top:-20px;" class="card-body">
                  ...
                  <br>
                  <h7>Status :  <?php if ($pengaduan->status == 1): ?>
                                               proses
                                            <?php else: ?>
                  ...
                  <hr>
                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal"><i class="fa fa-edit"></i> Edit Status</button>
                  <button type="submit" class="btn btn-dark"><i class="fa fa-paper-plane"></i> Kirim</button>
                  </form>
                </div>
              </div>
            </div>
