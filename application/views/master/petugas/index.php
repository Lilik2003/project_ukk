    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info">
                <strong>Note : </strong> Jika anda menghapus data petugas maka semua data tanggapan dengan ID yang sama
                akan juga terhapus
            </div>
            <div class="card shadow">
                <div class="card-body">
                    <a style="background-color:background: rgb(38,225,233);
background: linear-gradient(270deg, rgba(38,225,233,1) 0%, rgba(0,0,0,1) 93%);" href="<?= base_url('master/add_petugas'); ?>"  class="btn btn-info mb-3"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('master/del_petugas/') . $p->id_admin; ?>"
                                            ...
                                            <?= anchor('master/edit_petugas/' . $p->id_admin, '<div class="btn btn-primary btn btn-sm"><i class="fas fa-pen"></i></div>') ?>
