<body>
    ...
    <section class="home-slider owl-carousel">
        <div class="slider-item" style="background-image:url(images/komentar.jpg); background-size:1000px;">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-10 ftco-animate text-center">
                        <div class="text mb-5 pb-3">
                            <h1 style="font-family:sans sherif;" class="mb-3">selamat datang di pengaduan masyarakat</h1>
        ...
        <div class="slider-item" style="background-image:url(images/komplen.jpg); background-size:1500px;">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-10 ftco-animate text-center">
