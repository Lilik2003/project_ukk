  ...
  <div class="row">
      ...
      <div class="card shadow border-left-danger">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Jumlah Petugas</div>
    ...
    <div class="col-lg-12">
      <table class="table table-striped table-bordered">
        <thead class="bg-info">
          <tr style="background: rgb(38,225,233);
background: linear-gradient(270deg, rgba(38,225,233,1) 0%, rgba(0,0,0,1) 93%);">
            <th style="color:white;">Tanggal pengaduan</th>
            <th style="color:white;">Isi Pengaduan</th>
          </tr>
        </thead>
        <tbody>
